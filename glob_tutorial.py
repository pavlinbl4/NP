...
def find_files_by_extension_recursiv(path_to_folder: str, extension: str, ):
...
files = glob.glob('/Users/evgeniy/Downloads/*.[jJ][pP][gG]') + glob.glob('/Users/evgeniy/Downloads/*.[jJ][pP][eE][gG]')
# print(files)
